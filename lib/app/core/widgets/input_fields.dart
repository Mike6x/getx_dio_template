...
import '../utils/flutter/utilities.dart';
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: AppColors.textColorAccent,
        hintStyle: TextStyle(color: Colors.grey.withOpacity(.75)),
        contentPadding:
            const EdgeInsets.symmetric(vertical: 0.0, horizontal: 20.0),
        border: OutlineInputBorder(
          borderSide: const BorderSide(
              color: AppColors.textColorPrimary, width: 1.0),
          borderRadius: FxRadius.all(10.0),
        ),
        focusedBorder: OutlineInputBorder(
          borderSide: const BorderSide(
              color: AppColors.textColorSecondary, width: 1.0),
          borderRadius: FxRadius.all(10.0),
        ),
        errorBorder: OutlineInputBorder(
          borderSide: const BorderSide(
              color: AppColors.errorColor, width: 1.0),
          borderRadius: FxRadius.all(10.0),
        ),
